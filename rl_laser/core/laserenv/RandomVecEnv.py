...
class RandomDummyVecEnv(DummyVecEnv):
    ...
    def has_attr(self, attr_name: str, indices=None) -> List[bool]:
        """Return whether vectorized env has attr_name attribute"""
        target_envs = self._get_target_envs(indices)
        return [hasattr(env, attr_name) for env in target_envs]
    ...
    def env_method(self, method_name: str, *method_args, indices=None, **method_kwargs) -> List[Any]:
        ...
        target_envs = self._get_target_envs(indices)
        return [env.get_wrapper_attr(method_name)(*method_args, **method_kwargs) for env in target_envs]
